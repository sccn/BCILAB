...
arg_define(varargin, ...
    ...
    arg({'in_port','InputPort'}, 12345, uint32([1 65535]),'Source TCP port. Depends on the source application, usually > 1024.'), ...
    ...
    arg({'out_port','OutputPort'}, 12346, uint32([1 65535]),'Destination TCP port. Depends on the destination application, usually > 1024.'), ...
    arg({'out_srate','OutputSamplingRate'}, 20,[0 Inf],'Output sampling rate. This is the rate at which estimate should be computed. If this value is too high, the BCI will start to lag behind.'), ...
