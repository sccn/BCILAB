...
%
%   MarkerQuery : Marker stream query. Allows to select a marker stream to read from (e.g., by setting 
...
%                               2012-03-21
    ...
    opts = arg_define(varargin, ...
        ...
        arg({'data_query','DataStreamQuery'}, 'type=''EEG''',[],'Data stream query. Allows to select a data stream to read from (e.g., by setting it to type=''EEG'' or name=''BioSemi'').'), ...
        arg({'marker_query','MarkerStreamQuery'},'type=''Markers''',[],'Marker stream query. Allows to select a marker stream to read from (e.g., by setting it to type=''Markers''). Leave it empty to ignore markers.','shape','row','type','char'), ...
