...
%                               2012-03-21
    ...
    opts = arg_define(varargin, ...
        arg({'new_stream','MatlabStreamName','MatlabStream'}, 'laststream',[],'MATLAB Stream Name. A variable with this name will be created in the MATLAB workspace to hold the stream''s data. If such a variable already exists it will be overridden.'), ...
