...
arg_define(varargin, ...
    ...
    arg({'fltlen','FilterLength'}, 10, uint32([0 10000]), 'Filter length. This determines both the quality and the delay of the resampling. The default should be fine.','shape','scalar','guru',true), ...
