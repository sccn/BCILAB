...
arg_define(varargin, ...
    ...
    arg({'ignored_quantile','IgnoredQuantile'}, 0.1, [0 0.05 0.2 1], 'Quantile of highest correlations ignored. Upper quantile of the correlation values that may be arbitrarily high without affecting the outcome - avoids problems with shorted channels.'), ...
