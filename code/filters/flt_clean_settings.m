...
make_clean_params = @(flatlines,drifts,hf_cutoff,regression,windows,channels,dropouts,peaks,spikes,shaping) { ...
    ...
    arg_subtoggle({'dropouts','ChannelDropoutRepair','ChannelRepair','GlitchRemoval'},dropouts,@flt_repair_channels,'Repair of channels that temporarily glitch out.'), ...
    arg_subtoggle({'pcasubspace','BadSubspaceRemoval','BurstRepair','bursts','BurstRemoval'},peaks,@flt_repair_bursts,'Repair of high-power subspaces per window.'), ...
