...
arg_define(varargin,...
    ...
    arg({'mtbandwidth','TimeBandwidth'},3,[],'Spectral smoothing. Controls the bias vs. variance of the spectral estimation.'), ...
    arg({'mttapers','Tapers'},[],[],'Number of tapers. Should be an integer smaller than 2*TimeBandwith; default 2*TimeBandwidth-1','guru',true), ...
