...
arg_define([0 2],varargin, ...
    ...
    'amica', { ...
        ...
        arg({'max_iter','MaxIterations'},uint32(2500),[],'Maximum number of iterations to perform.','cat','Core Parameters'), ...
        arg({'num_models','NumModels'},uint32(1),[],'Number of models to learn. Per model, approx. 100,000 data points are needed at 100 channels.','cat','Core Parameters'), ...
        arg({'num_mix_comps','NumMixtureComponents'},uint32(3),[],'Number of mixture components to learn. This is per source.','cat','Core Parameters'), ...
        ...
        ...
        arg({'max_threads','MaxThreads'},[],[],'Number of threads per node. If this is too high, churn kicks in (especially between users on a shared cluster).','cat','Compute Resources'), ...
        arg({'useqsub','UseGridEngine','qsub'},fastif(isdeployed,'off','on'),{'on','off'},'Use Sun Grid Engine cluster. Assumes qsub; the alternative is to run locally.','cat','Compute Resources'), ...
        ...
        arg({'numprocs','NumProcessors','num_procs'},uint32(32),[],'Number or processors to use. If use_queue was used with auto-detection, the # of slots in the queue will be used as numprocs.','cat','Compute Resources'), ...
        arg({'poll_interval','PollInterval'},10,[],'Check Amica status every n secs. Used to monitor Amica''s progress, if running on a cluster.','cat','Compute Resources'), ...
        arg({'max_start_waiting','MaxStartWaiting'},600,[],'Maximum wait time until Amica reschedule. If running on a cluster, maximum waiting time (if job not launched) until it is assumed that the AMICA job could not be scheduled, in seconds.','cat','Compute Resources'), ...
        arg({'max_init_waiting','MaxInitWaiting'},2000,[],'Maximum wait time until Amica reschedule. If running on a cluster, maximum waiting time (if computation not initialized) until it is assumed that the AMICA job does not make progress (e.g., due to a straggler), in seconds.','cat','Compute Resources'), ...
        arg({'reduce_factor','ReductionFactor'},0.75,[],'Processor reduction per restart. If running on a cluster, factor by which the number of processors is reduced when the maximum waiting time is exceeded.','cat','Compute Resources'), ...
        ...
        arg({'max_restarts','MaxRestarts'},20,[],'Maximum number of restarts. If amica has been restarted more than this many times (due to optimistic scheduling or NaN outputs), fall back to the MATLAB implementation.','cat','Compute Resources'), ...
        arg({'fallback_reduce','FallbackReductionFactor'},0.5,[],'Iteration reduction after fallback. If falling back, reduce maximum number of iterations by this factor (for time reasons).','cat','Compute Resources'), ...
        arg({'measure_window','ThroughputMeasurementWindow'},5*60,[],'Throughput Measurement Window. Amica computational throughput is measured within this past window (in seconds) to determine whether a re-schedule can significantly improve the expected running time.','cat','Compute Resources'), ...
        arg({'benefit_threshold','SpeedupRestartThreshold'},3,[],'Minimum speedup to justify a restart. If the expected speedup due to a restart is at least this high, restart the computation.','cat','Compute Resources'), ...
        arg({'native_threshold','NativeFallbackThreshold'},10,[],'Minimum speedup to justify a fallback. If the expected speedup due to a restart is at least this high, but we have already re-started MaxRestarts times, we fall back to a local MATLAB-based computation.','cat','Compute Resources'), ...
        ...
        arg({'reuse_margin','DirectoryReuseSafetyMargin'},5,[],'Safety margin for directory reuse. When selecting a directory to write results to, make sure that it has not been updated with (incomplete) results within the last n minutes.','cat','Compute Resources'), ...
        arg({'min_numprocs_fraction','MinimumNumProcsFraction'},0.33,[],'Minimum fraction of NumProcessors. If amica gives NaN''s, this is sometimes due to the number of processors chosen - so we use a random # of processors between this fraction and your original number if it crashes, until it eventually works.','cat','Compute Resources'), ...
        ...
        arg({'lrate','LRate'},0.1,[],'Initial learning rate for natural gradient. Extended Infomax only.','cat','Computation'), ...
        arg({'lratefact','LRateFactor'},0.5,[],'Learning rate reduction. Multiplicative factor by which to decrease learning rate (extended Infomax only).','cat','Computation'), ...
        arg({'minlrate','MinLRate'},1e-8,[],'Minimum learning rate. If lower, convergence is assumed; extended Infomax only.','cat','Computation'), ...
        arg({'rholrate','ShapeLRate'},0.05,[],'Initial learning rate for shape parameters. Only for generalized Gaussian mode.','cat','Computation'), ...
        arg({'rholratefact','ShapeLRateFactor'},0.5,[],'Shape learning rate reduction. Multiplicative factor by which to decrease the shape learning rate. Generalized Gaussian only.','cat','Computation'), ...
        arg({'rho0','InitialShape'},1.5,[],'Initial shape parameter value. Generalized Gaussian only.','cat','Computation'), ...
        arg({'minrho','MinShape'},1.0,[],'Minimum shape parameter value. Generalized Gaussian only.','cat','Computation'), ...
        arg({'maxrho','MaxShape'},2.0,[],'Maximum shape parameter value. Generalized Gaussian only.','cat','Computation'), ...
        arg({'do_newton','DoNewton'},true,[],'Use the Newton method.','cat','Computation'), ...
        arg({'newt_start','NewtonStartIter'},uint32(50),[],'Iterations without Newton method. Only after this many iterations, the Newton method is used.','cat','Computation'), ...
        arg({'newtrate','NewtonRate'},1.0,[],'Learning rate for Newton iterations.','cat','Computation'), ...
        arg({'newt_ramp','NewtonRampUp'},uint32(10),[],'Iterations to ramp up Newton method.','cat','Computation'), ...
        arg({'comp_thresh','ComponentThreshold'},0.98,[],'Correlation Threshold to share components.','cat','Computation'), ...
        arg({'share_start','ShareStartIter'},100,[],'Iteration to start component sharing.','cat','Computation'), ...
        arg({'share_int','ShareInterval'},100,[],'Iterations between component sharing checks.','cat','Computation'), ...
        ...
        ...
        arg({'writestep','WriteInterval'},uint32(10),[],'Iterations between output writes.','cat','File IO'), ...
        ...
        arg({'numrej','RejectCycles'},uint32(3),[],'Number of rejections to perform in total.','cat','Artifact Handling'), ...
        arg({'rejsig','RejectSigma'},3,[],'Likelihood threshold for rejection (stddev). This is the number of standard deviations of likelihood below which to reject data.','cat','Artifact Handling'), ...
        arg({'rejstart','RejectStart'},uint32(2),[],'Iteration at which to start rejection.','cat','Artifact Handling'), ...
        arg({'rejint','RejectInterval'},uint32(3),[],'Iterations between successive rejections.','cat','Artifact Handling'), ...
        arg({'kurt_start','KurtosisStart'},uint32(3),[],'Iterations without kurtosis calculations. This is for Extended Infomax only.','cat','Artifact Handling'), ...
        arg({'num_kurt','KurtosisCycles'},uint32(5),[],'Number of kurtosis calcs to perform. This is for Extended Infomax only.','cat','Artifact Handling'), ...
        arg({'kurt_int','KurtosisInterval'},uint32(1),[],'Iterations between successive kurtosis calculations. This is for Extended Infomax only.','cat','Artifact Handling'), ...
        ...
        ...
        arg({'scalestep','ScaleInterval'},uint32(1),[],'Iterations between unmixing matrix rescaling.','cat','Miscellaneous'), ...
        arg({'block_size','BlockSize'},uint32(128),[],'Matrix block size for block multiplication.','cat','Miscellaneous'), ...
        arg({'verbose','Verbose'},true,[],'Show progress updates.','cat','Miscellaneous')}, ...
    'infomax',{ ...
        arg({'maxsteps','MaxIterations'},512,[],'Maximum number of ICA training steps.','cat','Core Parameters'), ...
        ...
        arg({'pca','RetainPCAs'},uint32(0),[],'Do a PCA dimensionality reduction. Value is the number of PCs to retain (0=off)','cat','Core Parameters'), ...
        ...
        arg({'annealdeg','AnnealChange'},60,[],'Weight change threshold for annealing steps. In degrees.','cat','Computation'), ...
        arg({'pstop','MinWeightChange','stop'},0.000001,[],'Minimum weight change to signal convergence.','cat','Computation'), ...
        ...
    ...
    'beamica', { ...
        arg({'max_iter','MaxIterations'},750,[],'Maximum number of iterations.'), ...
        ...
        arg({'tradeoff','BeamPenaltyStrength'},0.5,[0 1],'Beamformer penalty strength. Larger values emphasize the beamformer constraint over the Infomax cost function.','experimental',true), ...
        ...
        arg({'usegpu','TryUseGPU'},true,[],'Try to use the GPU.'), ...
    ...
    'fastica', { ...
        arg({'maxNumIterations','MaxIterations'},1000,[],'Maximum number of iterations.','cat','Core Parameters'), ...
        ...
        arg({'maxFinetune','MaxFinetune'},100,[],'Maximum number of iterations in fine-tuning.','cat','Convergence'), ...
     ...
     'rica', { ...
        ...
        arg({'lambda','Lambda'},0.05,[],'Sparsity/accuracy tradeoff. The lambda parameter in sparse dictionary learning.'), ...
        arg({'gamma','Gamma'},0.01,[],'Anchoring tradeoff. This is the tradeoff parameter associated with the anchor constraint term.'), ...
        arg({'theta','Theta'},1,[],'Reconstruction tradeoff. This is the tradeoff parameter associated with the reconstruction cost.'), ...
        ...
        arg({'max_restarts','MaxRestarts'},20,[],'Maximum # of restarts. When weights blow up or etc.'), ...
        arg({'cov_blocksize','CovarianceBlocksize'},10,[],'Robust blocksize. Blocksize for robust estimation (currently only covariance).'), ...
        arg({'initialization','Initialization'},'radial',{'random','radial'},'Initialization. Either randomly or using radial (sphering) components.'), ...
        arg({'cov_rejection','CovarianceRejection'},5,[],'Covariance-based rejection. Rejects samples that are beyond this many std-devs from a robustly estimated data distribution.'), ...
        ...
        arg_sub({'solverOptions','SolverOptions'},{}, { ...
            arg({'MaxIter','MaxIterations'},75,[],'Maximum number of iterations.'), ...
            ...
            arg({'MaxFunEvals','MaxFunctionEvals'},1000,[],'Maximum function evaluations. Maximum number of function evaluations allowed (including during line searches).'), ...
     ...
     'kernelica', { ...
        ...
        arg({'restarts','NumRestarts'},1,[],'Number of restarts.','cat','Core Parameters'), ...
        arg({'kernel','KernelFunc'},'gaussian',{'gaussian','poly','hermite'},'Type of kernel for contrast function.','cat','Core Parameters'), ...
        ...
        arg({'GaussianSigma'},1,[],'Bandwidth parameter for the Gaussian kernel.','cat','Miscellaneous'), ...
        ...
        arg({'d','PolyDegree'},3,[],'Degree of the polynomial kernel.','cat','Miscellaneous'), ...
    ...
    'fastkernelica', { ...
        arg({'maxiter','MaxIterations'},20,[],'Maximum number of iterations.','cat','Core Parameters'), ...
        ...
        arg({'restarts','NumRestarts'},10,[],'Number of restarts. Multiple restarts are necessary to find the global optimum, especially with small kernel sizes.','cat','Core Parameters')} ...
    'sphere' {}, ...
    'robust_sphere', {}, ...
