...
arg_define(varargin, ...
    ...
    arg({'window_len','WindowLength'}, 30, [0 Inf], 'Length of normalization window. In seconds.'), ...
    ...
    arg({'lambda','CovarianceRegularization'}, 0.001, [0 1], 'Covariance regularization. This is a regularization parameter for the covariance estimate used in sperhing.','guru',true), ...
