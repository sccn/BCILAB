...
arg_define(varargin, ...
    ...
    arg({'max_flatline_duration','MaxFlatlineDuration'}, 5, [], 'Maximum tolerated flatline duration. In seconds. If a channel has a longer flatline than this, it will be considered abnormal.'), ...
    arg({'max_allowed_jitter','MaxAllowedJitter'}, 20, [], 'Maximum tolerated jitter during flatlines. As a multiple of epsilon.'), ...
    arg_deprecated({'min_stddev','MinimumStdDev'}, 0.0001, [], 'This parameter has no function any more.'), ...
