            ...
            args = arg_define(varargin, ...
                ...
                arg_sub({'fex','FeatureExtraction'},{},...
                    {arg({'spectral_prior','SpectralPrior'},@(f)1,[],'Spectral prior. Likelihood function of frequency in Hz.','guru',true), ...
                     ...
                     ...
                     arg({'freq_oversample','FrequencyOversampling'},2,[1 10],'Frequency oversampling.','guru',true), ...
                     arg({'sample_rate','SamplingRate'},15,[0 2 15 1000],'Sampling rate of the spectrum. In Hz.'), ...
                     arg({'freq_range','FrequencyRange'},[2.5 50],[0 0.5 200 1000],'Frequency range. In Hz, automatically clipped.'), ...
                     arg({'freq_scale','FrequencyScale'},'log',{'linear','log'},'Frequency scale.','guru',true), ...
                     arg({'win_size','WindowLength'},0.5,[0 0.1 5 Inf],'Overlapped window length. For time-frequency estimation, in seconds.'), ...
                     arg({'wavelet_cycles','WaveletCycles'},[3 0.5],[0 0.25 10 Inf],'Wavelet Cycles. At lower and upper frequency band edge.','guru',true) ...
