    ...
    methods
        ...
        function model = calibrate(self,varargin)
            ...
            args = arg_define(varargin, ...
                ...
                arg({'ref_weight','ReferenceWeight'},1,[0 Inf],'Reference weight. Relative weight of the reference set.'), ...
                ...
                arg({'subsample','Subsampling'}, 3, [1 100], 'Sub-sampling of the data. Larger means more samples/trials skipped.'),...
                arg({'testwindow','TestWindow'}, [-15 15], [], 'Online window length. This is the window length used for test-set prediction.'),...
                arg({'nfolds','NumFolds'},'auto',[],'Cross-validation folds. The cross-validation is used to determine the best regularization parameter.','type','expression'),...
