    ...
    methods
        ...
        function model = feature_adapt(self,varargin)
            args = arg_define(varargin, ...
                arg_norep('signal'), ...
                arg({'patterns','PatternPairs'},3,uint32([1 1000]),'Number of CSP patterns (times two).','cat','Feature Extraction'), ...
                ...
                arg({'steps','MaxIterations'},3,uint32([1 50]),'Number of iterations. A step is spatial optimization, followed by spectral optimization.','cat','Feature Extraction'));
