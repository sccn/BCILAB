    ...
    methods
        ...
        function model = calibrate_simple(self,varargin)
            ...
            args = arg_define(varargin, ...
                ...
                arg({'lambdas','Lambdas'},[2.^(8:-0.125:-5)],[],'Regularization parameter. Larger means stronger regularization, 1.0 is the Bayesian ad hoc choice.'), ...
                arg({'duration','WaveDuration'},0.8,[],'Duration of Waveform. This is the length of the waveform that will be searched in the epoch.'), ...
                arg({'stepping','Stepping'},3,[],'Relative jitter stepping. This is the precision (in samples) at which relative jitters will be considered.'), ...
                arg({'admm_iters','ADMMIterations'},30,[],'Max Iterations. Number of iterations for the overall ADMM solver.'), ...
                arg({'inner_iters','InnerIterations'},10,[],'Max Inner Iterations. Number of iterations for the inner ADMM solver that solves the sparsity vs trace norm.'), ...
                arg({'cg_iters','CgIterations'},30,[],'Max CG Iterations. Number of iterations for the inner conjugate-gradient solver.'), ...
                arg({'lanczos_iters','LanczosIterations'},10,[],'Max Lanczos Iterations. Number of iterations for the inner Lanczos solver.'), ...
                ...
                arg({'rho','AugmentedLagrangian'},1.0,[],'Augmented Lagrangian parameter.'), ...
                ...
                arg({'kappa','SparsityTraceTradeoff'},0.75,[],'Sparsity (=1) vs. Trace norm (=0) tradeoff. Between 0 and 1, similar to the elastic net criterion.'), ...
                arg({'patterns','NumPatterns'},20,[],'Number of weight patterns. This is the maximum number of (possibly distinct) weight patterns to recover.'), ...
