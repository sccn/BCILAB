    ...
    methods
        ...
        function model = calibrate(self,varargin)
            ...
            args = arg_define(varargin, ...
                ...
                arg({'beta','CovarianceShrinkage'},search(0:0.1:1),[],'Covariance shrinkage. This is the degree to which data from the goal subject is shrunken towards that of other subjects.'),...
