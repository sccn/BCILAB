            ...
            args = arg_define(varargin, ...
                ...
                arg_sub({'fex','FeatureExtraction'},{},...
                    {arg_nogui('chan_prior'), ... 
                     ...
                     arg({'freqwnds','WindowFreqs'},[0.5 5; 7 30],[0 1000],'Frequency bands of interest. Matrix containing one row for the start and end of each frequency band on which DAL shall operate. Values in Hz.','cat','Feature Extraction'), ...
