classdef ParadigmSPoC < ParadigmDataflowSimplified
    ...
    methods
        ...
        function model = feature_adapt(self,varargin)
            ...
            arg_define(varargin, ...
                arg_norep('signal'), ...
                arg({'patterns','PatternPairs'},3,[],'Number of SPoC patterns (times two).','cat','Feature Extraction','type','expression','shape','row'), ...
                arg({'cov_lambda','CovarianceRegularization','lambda'}, 0.001, [], 'Covariance regularization. This is a regularization parameter for the covariance estimate.'));
