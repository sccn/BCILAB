    ...
    methods
        ...
        function model = feature_adapt(self,varargin)
            ...
            args = arg_define(varargin, ...
                ...
                arg({'winfunc','WindowFunction'},'hamming',{'barthann','bartlett','blackman','blackmanharris','bohman','cheb','flattop','gauss','hamming','hann','kaiser','nuttall','parzen','rect','taylor','triang','tukey'},'Type of window function. Typical choices are rect (rectangular), hann, gauss, blackman and kaiser.'),...
