classdef ParadigmSpectralmeans < ParadigmDataflowSimplified
    ...
    methods
        ...
        function model = feature_adapt(self,varargin)
            arg_define(varargin, ...
                arg_norep('signal'), ...
                arg({'wnds','FreqWindows'},[0.5 3; 4 7; 8 12; 13 30; 31 42],[0 1000],'Frequency bands to take as features. Matrix containing one row for the start and end of each frequency band over which the signal mean (per every channel) is taken as a feature. Values in Hz.','cat','Feature Extraction'), ...
