...
opts = arg_define(varargin, ...
    ...
    arg({'pool','ClusterPool'},'global',[],'Cluster resource pool. If set to global, the global BCILAB setting (as of par_globalsetting) will be used. Otherwise, this is a cell array of hostnames (and optionally ports) of remote worker processes.'), ...
    arg({'policy','ClusterPolicy'},'global',[],'Cluster scheduling policy. If set to global, the global setting (as of par_globalsetting) will be chosen. Otherwise, this may be the name of a custom scheduling policy function.'));
