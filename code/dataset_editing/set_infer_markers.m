...
arg_define(varargin, ...
    ...
    arg({'max_events','MaxEvents'},30000,uint32([0 Inf]), 'Number of events allowed. If a channel would produce more than this many events, it is not considered an event channel.'), ...
    ...
    arg({'max_types','MaxTypes'},300,uint32([0 Inf]), 'Number of eventtypes allowed. If a channel would produce more than this many event types, it is not considered an event channel.'), ...
