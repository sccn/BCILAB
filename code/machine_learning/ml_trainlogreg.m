...
arg_define([0 3],varargin, ...
    arg_norep('trials'), ...
    arg_norep('targets'), ...
    arg({'lam','Lambda','lambda'},  1, [0 Inf], 'Regularization parameter for l1/l2. A comprehensive search interval would be 2.^(-6:0.5:10).'), ...
    arg_subswitch({'variant','Variant'},'vb', ...
        {'vb',{},'vb-iter',{},'vb-ard',{},'l1',{},'l2',{}, ...
         'lars',{arg({'nfolds','NumFolds'},5,[0 Inf],'Cross-validation folds. The cross-validation is used to determine the best regularization parameter. If this is smaller than 1, it is taken as a fraction of the number of trials.'),...
                  arg({'foldmargin','FoldMargin'},0,[0 Inf],'Margin between folds. This is the number of trials omitted between training and test set.'), ...
                  arg({'alpha','ElasticMixing'},1,[0.01 1],'ElasticNet mixing parameter. The default is the lasso penalty.'), ...
                  arg({'nlambda','NumLambdas'},100,uint32([1 5000]),'Number of lambdas. Number of lambda (regularization) parameter values to consider.','guru',true), ...
                  ...
                  arg({'dfmax','MaxVariables'},0,[0 Inf],'Max #of variables. If specified, this constraints the maximum number of variables in the model.','guru',true), ...
                  arg({'pmax','MaxNonzeroes'},0,[0 Inf],'Max #of non-zeroes. If specified, this constraints the maximum number of non-zero variables in the model.','guru',true), ...
                  arg({'maxit','MaxIterations'},300,uint32([1 10000]),'Max iterations. The maximum number of iterations, if the convergence threshold is not reached.'), ...
