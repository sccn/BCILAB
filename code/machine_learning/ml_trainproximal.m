...
arg_define([0 2],varargin, ...
    ...
    arg_sub({'solverOptions','SolverOptions'},{},{ ...
        arg({'maxit','MaxIterations'},1000,uint32([1,10000]),'Maximum number of iterations.'), ...
        ...
        arg({'rho','CouplingParameter'},4,[0 Inf],'Initial coupling parameter. For proximal algorithms this is the coupling strength between the terms between updates. Increasing this can improve the convergence speed but too strong values can prevent any convergence.'), ...
        ...
        arg({'rho_cutoff','RhoUpdateThreshold'},10.0,[0 Inf],'Rho update threshold.','guru',true), ...
        arg({'rho_incr','RhoUpdateIncr'},2.0,[1 Inf],'Rho update increment factor.','guru',true), ...
        arg({'rho_decr','RhoUpdateDecr'},2.0,[1 Inf],'Rho update decrement factor.','guru',true), ...
    ...
    arg_sub({'lbfgsOptions','LBFGSOptions'},{},{ ...
        arg({'MaxIter','MaxIterations'},10,uint32([1 1000]),'Maximum number of iterations.'), ...
        arg({'m','HessianHistory'},6,uint32([1 20]),'LBFGS history length. The number of corrections to approximate the inverse hessian matrix.','guru',true), ...
        ...
        arg({'max_linesearch','MaxLineSearch'},40,uint32([0 1000]),'Maximum number of trials for the line search.','guru',true), ...
    ...
    arg_sub({'lambdaSearch','LambdaSearch'},{},{ ...
        ...
        arg({'foldmargin','FoldMargin'},0,uint32([0 1000]),'Margin between folds. This is the number of trials omitted between training and test set.'), ...
