...
arg_define([0 3],varargin, ...
    ...
    arg({'sparse_basis','NumBasisFunc'}, uint32(500), [], 'Mumber of basis functions. For sparse kernel approximation.','cat','Miscellaneous','guru',true), ...
    arg({'restarts','NumRestarts'}, 0, [], 'Number of restarts. Number of times to recompute the sparse kernel approximation and restart the optimizer.','cat','Miscellaneous','guru',true), ...
