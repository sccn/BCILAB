...
opts = arg_define([0 2],varargin, ...
    ...
    arg({'gammap','KernelScale','gamma'}, search(2.^(-16:2:4)), [0 2^-20 2^10 Inf], 'Scaling of the kernel functions. Should match the size of structures in the data. A reasonable range is 2.^(-16:2:4).','cat','Core Parameters'), ...
    ...
    ...
    arg({'iterations','MaxIterations'}, 100000, uint32([1 100000]), 'Number of iterations to run.','cat','Miscellaneous'), ...
