...
arg_define([0 3],varargin, ...
    arg_norep('trials'), ...
    arg_norep('targets'), ...
    arg({'lambdas','Lambdas'}, 2.^(10:-0.25:-5), [0 Inf], 'Regularization parameters. Controls the sparsity/simplicity of the result. Typically, this is an interval to scan, such as 2.^(10:-1:-15).'), ...
    ...
    arg({'foldmargin','FoldMargin'},5,[0 Inf],'Margin between folds. This is the number of trials omitted between training and test set.'), ...    
