...
allopts = arg_define([0 1],varargin,...
    ...
    arg({'types','ChannelTypes','type'},[],[],'Channel type subset. Restrict the loaded channels to those with matching types; should be a cell-array of strings.','type','cellstr','typecheck',false), ...
