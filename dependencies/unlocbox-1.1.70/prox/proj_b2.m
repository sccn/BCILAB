function [sol, u,iter] = proj_b2(x, ~, param)
%PROJ_B2 Projection onto a L2-ball
%   Usage:  sol=proj_b2(x, ~, param)
%           [sol, u, iter]=proj_b2(x, ~, param)
%
%   Input parameters:
%         x     : Input signal.
...
%   |Y - A Z|2 < epsilon. So it can be written:
%
