function [xmin,fmin,funccount] = brentmin(xlow,xupp,Nitmax,tol,f,varargin)
% BRENT Brent's minimization method in one dimension taken from:
...
%
% [xmin,fmin] = BRENTMIN(xlow,xupp,Nit,tol,f,varargin)
...
% f, varargin: f(x,varargin{:}) is the function
%
% OUTPUT
...
while ( abs(xf-xm) > (tol2 - 0.5*(b-a)) )
    ...
    if funccount >= Nitmax
        ...
        % warning(sprintf('Maximum number of iterations (%d) exceeded: precision is not guaranteed',Nitmax))
