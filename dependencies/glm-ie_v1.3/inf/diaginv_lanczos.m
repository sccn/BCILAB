% [z,ldT,Q,T] = DIAGINV_LANCZOS(X,R,B,P,kmax,output)
%
...
function [z,ldT,Q,T] = diaginv_lanczos(X,R,B,P,kmax,output)
...
v = zeros(n,1); b = 1; k = 0;
Q = zeros(n,kmax); z = 0;                    % memory for the Lanczos and result
...
if nargout>3, T = diag(alpha)+diag(beta,+1)+diag(beta,-1); end
