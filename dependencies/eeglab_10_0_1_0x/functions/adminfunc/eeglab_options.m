...
try,    
    ...
    if iseeglabdeployed
        com1 = readtxtfile(fullfile(eeglaboptionsfolder, 'eeg_optionsbackup.txt'));
        com2 = readtxtfile(fullfile(eeglaboptionsfolder, 'eeg_options.txt'));
        eval( com1 );
        eval( com2 );
    else
        eeg_optionsbackup;
    ...
    try
        ...
        disp('The option option_savetwofiles was not found.');
    end
