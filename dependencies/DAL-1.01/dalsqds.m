% dalsql1 - DAL with the squared loss and the dual-spectral regularization
%
% Overview:
%  Solves the optimization problem:
%   xx = argmin ||A*x-bb||^2 + lambda*||x||_DS
%
% Syntax:
%  [xx,status]=dalsqds(xx, A, bb, lambda, <opt>)
%
% Inputs:
...
function [ww,status]=dalsqds(ww,A,bb, lambda, varargin)
