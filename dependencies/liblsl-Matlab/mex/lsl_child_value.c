...
/* function [ChildValue] = lsl_child_value(LibHandle,DescPtr) */
		  ...
		  int nrhs, const mxArray*prhs[] ) 
{
    ...
    /* get function handle */
    field = mxGetField(prhs[0],0,"lsl_child_value");
    if (!field)
        mexErrMsgTxt("The field does not seem to exist.");
    pTmp = (uintptr_t*)mxGetData(field);
    if (!pTmp)
        mexErrMsgTxt("The field seems to be child_value.");
